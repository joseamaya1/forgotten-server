...
local function clearForgottenLastLore()
	...
	Game.setStorageValue(GlobalStorage.ForgottenKnowledge.LastLoreTimer, 0)
end
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if item.itemid == 9825 then
		...
		addEvent(clearForgottenLastLore, 30 * 60 * 1000)
		item:transform(9826)
