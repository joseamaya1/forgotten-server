...
local function clearForgottenTimeGuardian()
	...
	Game.setStorageValue(GlobalStorage.ForgottenKnowledge.TimeGuardianTimer, 0)
end
...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	if item.itemid == 9825 then
		...
		addEvent(clearForgottenTimeGuardian, 30 * 60 * 1000)
		item:transform(9826)
